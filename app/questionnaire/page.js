...
const page = () => {
  ...
  return (
    ...
    <div className={`${timesNewRoman.className} min-h-screen overflow-hidden`}>
        <MainSection subHead={"GET IN TOUCH WITH US"} mainHead={"Book Project Questionnaire"} />
        <div className={`${font2.className} flex bg-white flex-col overflow-hidden  items-center`}>
            <h1 data-aos="fade-down" className='text-3xl md:text-6xl font-bold bg-gradient-to-r from-red-900 to-zinc-800 bg-clip-text text-transparent pt-12 text-center'>Get In Touch With Us</h1>
        ...
        <div className="md:w-[100%] w-full space-y-8">
          <form onSubmit={handleSubmit} className="space-y-6 bg-gray-100 p-6 rounded-lg shadow-lg">
            ...
            <button onClick={handleSubmit} className="w-full bg-gradient-to-r from-red-800 to-black text-white p-2 rounded font-semibold">Submit</button>
          </form>
        </div>
              </div>
        <div/>
