      ...
      <div className='bg-white md:flex'>
          ...
          <div className='bg-gray-50 py-16 px-6 flex flex-col md:flex-row md:items-start md:justify-between'>
            ...
            <div className='md:w-1/2 max-w-4xl mb-8 md:mb-0'>
              ...
              <p className='text-gray-600 text-lg p-4 md:text-lg'>
            ...
            <div className='md:w-1/2 flex flex-wrap justify-center md:justify-start gap-6'>
              {/* Card 1 */}
              <div className='flex items-center justify-center w-[30%] h-40 bg-white p-4 rounded-lg shadow-md'>
              ...
              {/* Card 3 */}
              <div className='flex items-center justify-center w-[30%] h-40 bg-green-100 p-4 rounded-lg shadow-md'>
              ...
              {/* Card 5 */}
              <div className='flex items-center justify-center w-[30%] h-[40 bg-yellow-100 p-4 rounded-lg shadow-md'>
              ...
              {/* Card 7 */}
              <div className='flex items-center justify-center w-[30%] h-[40 bg-cyan-100 p-4 rounded-lg shadow-md'>
